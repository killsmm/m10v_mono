...
# echo 666666 > functions/uvc.usb0/streaming/mjpeg/mjpeg.hs/UHD/dwFrameInterval
# echo 666666 > functions/uvc.usb0/streaming/mjpeg/mjpeg.hs/UHD/dwDefaultFrameInterval
...
#mkdir -p /media/root/firmware
#mount -t ipcufs mnt /media/root/firmware -ofs=1
