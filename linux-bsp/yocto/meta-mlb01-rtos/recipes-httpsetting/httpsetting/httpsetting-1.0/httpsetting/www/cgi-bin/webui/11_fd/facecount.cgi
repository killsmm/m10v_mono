...
CNT=`echo $TMP | sed -e 's/\"//g'`

#FaceCount
#echo camera_if_direct 0x00010A00 0x200 $CNT>> $LOGF
#RESULT=$(camera_if_direct 0x00010A00 0x200 $CNT)
CMD="camera_if_direct 0x00010A00 0x200 $CNT"
echo $CMD >> $LOGF
RESULT=$($CMD)
#Response format
