...
#FD Draw Frame
#echo camera_if_direct 0x01010B00 0x200 $DFRM>> $LOGF
#RESULT=$(camera_if_direct 0x01010B00 0x200 $DFRM)
CMD="camera_if_direct 0x01010B00 0x200 $DFRM"
echo $CMD >> $LOGF
RESULT=$($CMD)
#Response format
#Receive response. Return 1 = 0x000000XX Return 2 = 0x00000000 Return 3 = 0x00000000 Return 4 = 0x00000000 0x81010B00:0x200 succesfully. Camera IF command end.
