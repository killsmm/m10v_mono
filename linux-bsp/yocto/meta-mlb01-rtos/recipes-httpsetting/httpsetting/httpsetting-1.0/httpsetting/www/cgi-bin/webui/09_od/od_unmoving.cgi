...
UMV=`echo $TMP | sed -e 's/\"//g'`

#OD Unmoving Conf
#echo camera_if_direct 0x01010D00 0x00000900 $CH $UMV>> $LOGF
#RESULT=$(camera_if_direct 0x01010D00 0x00000900 $CH $UMV)
CMD="camera_if_direct 0x01010D00 0x00000900 $CH $UMV"
echo $CMD >> $LOGF
RESULT=$($CMD)
#Response format
#Receive response. Return 1 = 0x000000XX Return 2 = 0x00000000 Return 3 = 0x00000000 Return 4 = 0x00000000 0x01010D00:0x00000900 succesfully. Camera IF command end.
