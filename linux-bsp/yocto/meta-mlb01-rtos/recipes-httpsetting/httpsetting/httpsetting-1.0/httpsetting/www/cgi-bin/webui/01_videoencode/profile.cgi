...
PF=`echo $TMP | sed -e 's/\"//g'`

#Profile
#echo camera_if_direct 0x00010300 0x700 $CH $PF>> $LOGF
#RESULT=$(camera_if_direct 0x00010300 0x700 $CH $PF)
CMD="camera_if_direct 0x00010300 0x0700 $CH $PF"
echo $CMD >> $LOGF
RESULT=$($CMD)
#Response format
