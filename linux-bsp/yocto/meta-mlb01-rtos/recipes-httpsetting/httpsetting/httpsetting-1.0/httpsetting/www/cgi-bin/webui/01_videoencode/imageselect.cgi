...
IMG=`echo $TMP | sed -e 's/\"//g'`
TMP=$(echo "$QUERY_STRING" | jq ".arg2")
EN=`echo $TMP | sed -e 's/\"//g'`


#ImageSelect
#echo camera_if_direct 0x01010700 0x200 $IMG $EN >> $LOGF
#RESULT=$(camera_if_direct 0x01010700 0x200 $IMG $EN)
CMD="camera_if_direct 0x01010700 0x0200 $IMG $EN"
echo $CMD >> $LOGF
RESULT=$($CMD)
