...
#PD Meta
#echo camera_if_direct 0x01010C00 0x100 $META>> $LOGF
#RESULT=$(camera_if_direct 0x01010C00 0x100 $META)
CMD="camera_if_direct 0x01010C00 0x100 $META"
echo $CMD >> $LOGF
RESULT=$($CMD)
#Response format
#Receive response. Return 1 = 0x000000XX Return 2 = 0x00000000 Return 3 = 0x00000000 Return 4 = 0x00000000 0x81010C00:0x100 succesfully. Camera IF command end.
