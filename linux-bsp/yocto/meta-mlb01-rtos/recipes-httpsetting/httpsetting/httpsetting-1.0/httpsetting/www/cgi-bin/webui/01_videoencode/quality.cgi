...
Q_VAL=`echo $TMP | sed -e 's/\"//g'`

#Quality
#echo camera_if_direct 0x00010300 0x0800 $Q_VAL>> $LOGF
#RESULT=$(camera_if_direct 0x00010300 0x0800 $Q_VAL)
CMD="camera_if_direct 0x00010300 0x0800 $Q_VAL"
echo $CMD >> $LOGF
RESULT=$($CMD)
#Response format
#Receive response. Return 1 = 0x000000XX Return 2 = 0x00000000 Return 3 = 0x00000000 Return 4 = 0x00000000 0x81011100:0x100 succesfully. Camera IF command end.
