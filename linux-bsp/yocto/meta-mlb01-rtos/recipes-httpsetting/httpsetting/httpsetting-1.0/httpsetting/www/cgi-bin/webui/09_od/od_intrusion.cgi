...
#OD Intrusion(Enabled)
#echo camera_if_direct 0x01010D00 0x00000300 $EN>> $LOGF
#RESULT=$(camera_if_direct 0x01010D00 0x00000300 $EN)
CMD="camera_if_direct 0x01010D00 0x00000300 $EN"
echo $CMD >> $LOGF
RESULT=$($CMD)
#Response format
#Receive response. Return 1 = 0x000000XX Return 2 = 0x00000000 Return 3 = 0x00000000 Return 4 = 0x00000000 0x01010D00:0x00000300 succesfully. Camera IF command end.
