...
W=`echo $TMP | sed -e 's/\"//g'`
TMP=$(echo "$QUERY_STRING" | jq ".arg4")
L=`echo $TMP | sed -e 's/\"//g'`


#ImageSelect
#echo camera_if_direct 0x01010700 0x300 $X $Y $W $L >> $LOGF
#RESULT=$(camera_if_direct 0x01010700 0x300 $X $Y $W $L)
CMD="camera_if_direct 0x01010700 0x0300 $X $Y $W $L"
echo $CMD >> $LOGF
RESULT=$($CMD)
