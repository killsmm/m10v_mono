...
META=`echo $TMP | sed -e 's/\"//g'`

#FD Meta
#echo camera_if_direct 0x01010B00 0x100 $META>> $LOGF
#RESULT=$(camera_if_direct 0x01010B00 0x100 $META)
CMD="camera_if_direct 0x01010B00 0x100 $META"
echo $CMD >> $LOGF
RESULT=$($CMD)
#Response format
