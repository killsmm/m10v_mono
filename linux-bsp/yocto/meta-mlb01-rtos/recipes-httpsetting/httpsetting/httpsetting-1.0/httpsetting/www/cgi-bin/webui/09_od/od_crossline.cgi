...
#OD Crossline(Enabled)
#echo camera_if_direct 0x01010D00 0x00000400 $EN>> $LOGF
#RESULT=$(camera_if_direct 0x01010D00 0x00000400 $EN)
CMD="camera_if_direct 0x01010D00 0x00000400 $EN"
echo $CMD >> $LOGF
RESULT=$($CMD)
#Response format
#Receive response. Return 1 = 0x000000XX Return 2 = 0x00000000 Return 3 = 0x00000000 Return 4 = 0x00000000 0x01010D00:0x00000400 succesfully. Camera IF command end.
