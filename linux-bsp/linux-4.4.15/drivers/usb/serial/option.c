...
static const struct usb_device_id option_ids[] = {
	...
	{ USB_DEVICE(0x1e0e, 0x9001) }, /* SIMCom 5G NDIS */ 
	{ USB_DEVICE(0x1e0e, 0x9011) }, /* SIMCom 5G RNDIS */ 
	{ USB_DEVICE(0x1e0e, 0x9018) }, /* SIMCom 5G ECM */ 
	{ USB_DEVICE(0x1e0e, 0x901E) }, /* SIMCom 5G MBIM */ 
#endif
			...
			const struct usb_device_id *id)
{
	...
	return -ENODEV; 
	if (serial->dev->descriptor.idVendor == cpu_to_le16(0x1E0E) && 
	serial->dev->descriptor.idProduct == cpu_to_le16(0x9011) 
	...
	return -ENODEV; 
	if (serial->dev->descriptor.idVendor == cpu_to_le16(0x1E0E) && 
	serial->dev->descriptor.idProduct == cpu_to_le16(0x9018) 
	&& serial->interface->cur_altsetting->desc.bInterfaceNumber >=5) 
	return -ENODEV; 
	if (serial->dev->descriptor.idVendor == cpu_to_le16(0x1E0E) && 
	serial->dev->descriptor.idProduct == cpu_to_le16(0x901E) 
	&& serial->interface->cur_altsetting->desc.bInterfaceNumber >=2) 
	return -ENODEV; 
#endif
