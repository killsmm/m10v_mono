...
/* H264 Payload - Video Frame Descriptor */
...
/* H.264 Payload - 3.1.1. H.264 Video Format Descriptor */
struct uvc15_format_h264 {
	__u8  bLength;
	__u8  bDescriptorType;
	__u8  bDescriptorSubType;
	__u8  bFormatIndex;
...
#define UVC15_DT_FORMAT_H264_SIZE			52

/* H.264 Payload - 3.1.2. H.264 Video Frame Descriptors */
struct uvc15_frame_h264 {
	__u8  bLength;
	__u8  bDescriptorType;
	__u8  bDescriptorSubtype;
	__u8  bFrameIndex;
...
#define UVC15_DT_FRAME_H264_SIZE(n)			(44+4*(n))

#define UVC15_FRAME_H264(n) \
	uvc15_frame_h264_##n

#define DECLARE_UVC15_FRAME_H264(n)			\
struct UVC15_FRAME_H264(n) {				\
	__u8  bLength;					\
	__u8  bDescriptorType;				\
	__u8  bDescriptorSubtype;			\
	__u8  bFrameIndex;				\
