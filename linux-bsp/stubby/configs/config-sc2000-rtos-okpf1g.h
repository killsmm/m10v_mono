...
#define CONFIG_TRAPOLINE_ADDRESS    (0x45DFFF00) //Secondary core jump address saving area
...
#define CONFIG_LINUX_ROMFS_ADDRESS	(0x00808000) // 
...
#define CONFIG_INITRAMFS_OFFSET		(0x40C00000-CONFIG_SYS_SDRAM_BASE) /* == 0x40C00000 PA */
