...
#define INV_NEEDS_ACCEL_MASK	((1UL<<1)|        (1UL<<3)|         (1UL<<9)|(1UL<<10)|(1UL<<11)|          (1UL<<15)|          (1UL<<17)|(1UL<<18)|(1UL<<19)|(1UL<<20)|(1UL<<23)|       (1UL<<25)|          (1UL<<29)|(1UL<<30)|(1UL<<31))
#define INV_NEEDS_GYRO_MASK		(                 (1UL<<3)|(1UL<<4)|(1UL<<9)|(1UL<<10)|(1UL<<11)|          (1UL<<15)|(1UL<<16)|                                                         (1UL<<25)|(1UL<<26)|(1UL<<29)|(1UL<<30)|(1UL<<31))
#define INV_NEEDS_COMPASS_MASK	(        (1UL<<2)|(1UL<<3)|                            (1UL<<11)|(1UL<<14)|                                                  (1UL<<20)|       (1UL<<24)|(1UL<<25)|                              (1UL<<31))
#define INV_NEEDS_PRESSURE		((1UL<<6)|(1UL<<28))
