...
//---------------------- driver  section -------------------------------
// Interrupt flag
#define	D_DD_HDMAC_FLG_CH0				(0x00000001)								/**< Event flag of channel 0 */
#define	D_DD_HDMAC_FLG_CH1				(0x00000002)								/**< Event flag of channel 1 */
#define	D_DD_HDMAC_FLG_CH2				(0x00000004)								/**< Event flag of channel 2 */
#define	D_DD_HDMAC_FLG_CH3				(0x00000008)								/**< Event flag of channel 3 */

// Num of channel
#define D_DD_HDMAC_CH_NUM_MAX			(4)											/**< The maximum values of number of channels */

// Return value of HDMAC processing result
#define	D_DD_HDMAC_SYSTEM_ERR			(D_DD_HDMAC | D_DDIM_SYSTEM_ERROR)			/**< System Error */
#define	D_DD_HDMAC_INPUT_PARAM_ERR		(D_DD_HDMAC | D_DDIM_INPUT_PARAM_ERROR)		/**< Input Parameter Error */
#define	D_DD_HDMAC_TIMEOUT_ERR			(D_DD_HDMAC | D_DDIM_TIMEOUT)				/**< Time Out */
#define	D_DD_HDMAC_EXC_LOCK_NG			(D_DD_HDMAC | D_DDIM_EXT_LOCK_NG)			/**< Exclusive control NG */
#define	D_DD_HDMAC_BUSY_ERR				(D_DD_HDMAC | D_DDIM_MACRO_BUSY_NG)			/**< HDMAC Busy */
#define	D_DD_HDMAC_SEM_NG				(D_DD_HDMAC | D_DDIM_SEM_NG)				/**< HDMAC Semaphore acquisition NG */
#define	D_DD_HDMAC_SEM_TIMEOUT			(D_DD_HDMAC | D_DDIM_SEM_TIMEOUT)			/**< HDMAC Semaphore acquisition Time Out */

// wait mode
#define	D_DD_HDMAC_WAITMODE_CPU			(0)											/**< CPU observes register mode  (interrupt no use) */
#define	D_DD_HDMAC_WAITMODE_EVENT		(1)											/**< event flg wait mode         (interrupt use) */

// HDMAC exclusion mode
#define D_DD_HDMAC_EXC_OFF				(0)											/**< Exclusive control release */
#define D_DD_HDMAC_EXC_ON				(1)											/**< Exclusive control setting */


/*** Value of setting DMACA register ***/
// Input Select(IS)
#define D_DD_HDMAC_IS_SOFT				(0x00)										/**< Software */
#define D_DD_HDMAC_IS_DREQ_H			(0x01)										/**< DREQ High level or Positive edge */
#define D_DD_HDMAC_IS_DREQ_L			(0x02)										/**< DREQ Low level or Negative edge */
#define D_DD_HDMAC_IS_IDREQ_0			(0x03)										/**< IDREQ[0] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_1			(0x04)										/**< IDREQ[1] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_2			(0x05)										/**< IDREQ[2] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_3			(0x06)										/**< IDREQ[3] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_4			(0x07)										/**< IDREQ[4] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_5			(0x08)										/**< IDREQ[5] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_6			(0x09)										/**< IDREQ[6] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_7			(0x0A)										/**< IDREQ[7] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_8			(0x0B)										/**< IDREQ[8] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_9			(0x0C)										/**< IDREQ[9] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_10			(0x0D)										/**< IDREQ[10] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_11			(0x0E)										/**< IDREQ[11] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_12			(0x0F)										/**< IDREQ[12] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_13			(0x10)										/**< IDREQ[13] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_14			(0x11)										/**< IDREQ[14] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_15			(0x12)										/**< IDREQ[15] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_16			(0x13)										/**< IDREQ[16] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_17			(0x14)										/**< IDREQ[17] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_18			(0x15)										/**< IDREQ[18] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_19			(0x16)										/**< IDREQ[19] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_20			(0x17)										/**< IDREQ[20] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_21			(0x18)										/**< IDREQ[21] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_22			(0x19)										/**< IDREQ[22] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_23			(0x1A)										/**< IDREQ[23] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_24			(0x1B)										/**< IDREQ[24] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_25			(0x1C)										/**< IDREQ[25] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_26			(0x1D)										/**< IDREQ[26] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_27			(0x1E)										/**< IDREQ[27] High level or Positive edge (reserved) */
#define D_DD_HDMAC_IS_IDREQ_28			(0x1F)										/**< IDREQ[28] High level or Positive edge (reserved) */

// Beat Type(BT)
#define D_DD_HDMAC_BT_NORMAL			(0x00)										/**< NORMAL (same as SINGLE) */
#define D_DD_HDMAC_BT_SINGLE			(0x08)										/**< SINGLE (same as NORMAL) */
#define D_DD_HDMAC_BT_INCR				(0x09)										/**< INCR */
#define D_DD_HDMAC_BT_WRAP4				(0x0A)										/**< WRAP4 */
#define D_DD_HDMAC_BT_INCR4				(0x0B)										/**< INCR4 */
#define D_DD_HDMAC_BT_WRAP8				(0x0C)										/**< WRAP8 */
#define D_DD_HDMAC_BT_INCR8				(0x0D)										/**< INCR8 */
#define D_DD_HDMAC_BT_WRAP16			(0x0E)										/**< WRAP16 */
#define D_DD_HDMAC_BT_INCR16			(0x0F)										/**< INCR16 */

/*** Value of setting DMACB register ***/
// Mode Select(MS)
#define D_DD_HDMAC_MS_BLK				(0x00)										/**< Block Transfer mode */
#define D_DD_HDMAC_MS_BURST				(0x01)										/**< Burst Transfer mode */
#define D_DD_HDMAC_MS_DEMAND			(0x02)										/**< Demand Transfer mode */

// Transfer Width(TW)
#define D_DD_HDMAC_TW_BYTE				(0x00)										/**< Byte */
#define D_DD_HDMAC_TW_HWORD				(0x01)										/**< Half-Word */
#define D_DD_HDMAC_TW_WORD				(0x02)										/**< Word */

// Fixed Source(FS)
#define D_DD_HDMAC_FS_INCR				(0x00)										/**< Source address is incremented */
#define D_DD_HDMAC_FS_FIX				(0x01)										/**< Source address is fixed */

// Fixed Destination(FD)
#define D_DD_HDMAC_FD_INCR				(0x00)										/**< Destination address is incremented */
#define D_DD_HDMAC_FD_FIX				(0x01)										/**< Destination address is fixed */

// Reload Count(RC)
#define D_DD_HDMAC_RC_DISABLE			(0x00)										/**< Reload function of the transfer count is disabled */
#define D_DD_HDMAC_RC_ENABLE			(0x01)										/**< Reload function of the transfer count is enabled */

// Reload Source(RS)
#define D_DD_HDMAC_RS_DISABLE			(0x00)										/**< Reload function of the source address is disabled */
#define D_DD_HDMAC_RS_ENABLE			(0x01)										/**< Reload function of the source address is enabled */

// Reload Destination(RD)
#define D_DD_HDMAC_RD_DISABLE			(0x00)										/**< Reload function of the destination address is disabled */
#define D_DD_HDMAC_RD_ENABLE			(0x01)										/**< Reload function of the destination address is enabled */

// Stop Status(SS)
#define D_DD_HDMAC_SS_NONE				(0x00)										/**< Initial value */
#define D_DD_HDMAC_SS_ADDR_OVER			(0x01)										/**< Address overflow (Error) */
#define D_DD_HDMAC_SS_STOP_REQ			(0x02)										/**< Transfer stop request (Error) */
#define D_DD_HDMAC_SS_SRC_ERR			(0x03)										/**< Source access error (Error) */
#define D_DD_HDMAC_SS_DST_ERR			(0x04)										/**< Destination access error (Error) */
#define D_DD_HDMAC_SS_NORMAL_END		(0x05)										/**< Normal end */
#define D_DD_HDMAC_SS_PAUSE				(0x07)										/**< HDMAC pause */

// Arbitration mode
#define D_DD_HDMAC_ARB_FIX				(0x00)										/**< priority fixed */
#define D_DD_HDMAC_ARB_ROTATE			(0x01)										/**< priority rotated */
...
typedef struct {
	U_DD_HDMAC_DMACA		config_a;		/**< Configuration A */
	U_DD_HDMAC_DMACB		config_b;		/**< Configuration B */
...
typedef struct {
	...
	ULONG					src_addr;		/**< Source Address */
	ULONG					dst_addr;		/**< Destination Address */
} T_DD_HDMAC_TRNS_SIZE;

/** HDMAC Transfer Control */
typedef struct {
	T_DD_HDMAC_TRNS_MODE	mode;			/**< Transfer mode set */
	T_DD_HDMAC_TRNS_SIZE	size;			/**< Transfer size set */
	VP_CALLBACK				int_handler;	/**< Interrupt Handler */
} T_DD_HDMAC_CTRL_TRNS;
...
if the channel state is in-use (lock), return "D_DD_HDMAC_EXC_LOCK_NG".
...
@retval D_DDIM_OK					OK
@retval D_DD_HDMAC_EXC_LOCK_NG		Lock Error (System Using designated channel number)
...
*/
extern	INT32	Dd_HDMAC_Open(UCHAR ch, INT32 tmout);

/**
The member who exists in the structure of "T_DD_HDMAC_CTRL" is set.<br>

@param [in] ch				Channel number (0 to 3)
@param [in] hdmac_ctrl		HDMAC control data. See @ref T_DD_HDMAC_CTRL
@retval D_DDIM_OK					OK
@retval D_DD_HDMAC_INPUT_PARAM_ERR	Input Parameter Error
@retval D_DD_HDMAC_BUSY_ERR		HDMAC is being forwarded. 
@remarks In the case of synchronous mode, please don't setting "int_handler". (It ignores, even if it has setting)<br>
         ...
         When you don't call "Dd_HDMAC_Wait_End()", please be sure to set up "int_handler".
*/
extern	INT32	Dd_HDMAC_Ctrl_Common(UCHAR ch, T_DD_HDMAC_CTRL const *const hdmac_ctrl);

/**
The member who exists in the structure of "T_DD_HDMAC_CTRL_TRNS" is set.<br>

@param [in] ch					Channel number (0 to 3)
@param [in] hdmac_ctrl_trans	HDMAC control data. See @ref T_DD_HDMAC_CTRL_TRNS
@retval D_DDIM_OK					OK
@retval D_DD_HDMAC_INPUT_PARAM_ERR	Input Parameter Error
@retval D_DD_HDMAC_BUSY_ERR			HDMAC is being forwarded. 
@remarks In the case of synchronous mode, please don't setting "int_handler". (It ignores, even if it has setting)<br>
         In the case of the asynchronous mode, an end can be supervised by calling "Dd_HDMAC_Wait_End()" or setting up "intHandler".<br>
         When you don't call "Dd_HDMAC_Wait_End()", please be sure to set up "int_handler".<br>
         <br>
...
*/
extern	INT32	Dd_HDMAC_Ctrl_Trns(UCHAR ch, T_DD_HDMAC_CTRL_TRNS const *const hdmac_ctrl_trans);

/**
The member who exists in the structure of "T_DD_HDMAC_TRNS_SIZE" is set.<br>

@param [in] ch					Channel number (0 to 3)
@param [in] hdmac_trns_size	HDMAC transfer size data. See @ref T_DD_HDMAC_TRNS_SIZE
@retval D_DDIM_OK					OK
@retval D_DD_HDMAC_INPUT_PARAM_ERR	Input Parameter Error
@retval D_DD_HDMAC_BUSY_ERR			HDMAC is being forwarded. 
@remarks 
         ...
         Transfer MAX size of this API as following.<br>
          ...
          - Demand Transfer mode<br>
         	...
         	BYTE transfer (source address and destination address are 1byte alignment) : MAX size is 64KByte.<br>
*/
extern	INT32	Dd_HDMAC_Set_Trns_Size(UCHAR ch, T_DD_HDMAC_TRNS_SIZE const *const hdmac_trns_size);
...
@param [in] wait_mode		HDMAC end wait mode (D_DD_HDMAC_WAITMODE_CPU or D_DD_HDMAC_WAITMODE_EVENT)
@retval D_DDIM_OK					OK
@retval D_DD_HDMAC_INPUT_PARAM_ERR	Input Parameter Error
@retval D_DD_HDMAC_TIMEOUT_ERR		time out
@retval D_DD_HDMAC_SYSTEM_ERR		system error
@remarks This API uses DDIM_User_Clr_Flg().
@remarks This API uses DDIM_User_Twai_Flg().
*/
extern	INT32	Dd_HDMAC_Start_Sync(UCHAR ch, USHORT *const status, UINT32 wait_mode);
...
@remarks This API uses DDIM_User_Twai_Flg().
*/
extern	INT32	Dd_HDMAC_Start_Async(UCHAR ch);
...
@retval D_DD_HDMAC_INPUT_PARAM_ERR	Input Parameter Error
*/
extern	INT32	Dd_HDMAC_Stop(UCHAR ch);
...
@retval D_DD_HDMAC_INPUT_PARAM_ERR	Input Parameter Error
*/
extern	INT32	Dd_HDMAC_Pause(UCHAR ch);
...
@remarks	This API uses DDIM_User_Clr_Flg().
*/
extern	INT32	Dd_HDMAC_Resume(UCHAR ch);
...
@retval D_DD_HDMAC_INPUT_PARAM_ERR	Input Parameter Error
*/
extern	INT32	Dd_HDMAC_Set_Wait_Time(UCHAR ch, INT32 wait_time);
...
@remarks	This API uses DDIM_User_Twai_Flg().
*/
extern	INT32	Dd_HDMAC_Wait_End(UCHAR ch, USHORT *const status, UINT32 wait_mode);
...
@retval D_DD_HDMAC_INPUT_PARAM_ERR	Input Parameter Error
*/
extern	INT32	Dd_HDMAC_Clear_Status(UCHAR ch);
...
*/
extern	INT32	Dd_HDMAC_Close(UCHAR ch);
...
@retval D_DD_HDMAC_INPUT_PARAM_ERR	Input Parameter Error
*/
extern	INT32	Dd_HDMAC_Get_Status(UCHAR ch, USHORT *const status);
...
@remarks This API forced cancel exclusive control if process is under executing.
*/
extern	ULONG	Dd_HDMAC_Get_Trns_Size(UCHAR ch);
...
@remarks This API forced cancel exclusive control if process is under executing.
*/
extern	ULONG	Dd_HDMAC_Get_Remain_Trns_Size(UCHAR ch);
...
*/
extern	ULONG	Dd_HDMAC_Get_Total_Trns_Size(UCHAR ch);
...
*/
extern	ULONG	Dd_HDMAC_Get_Src_Addr(UCHAR ch);
...
*/
extern	ULONG	Dd_HDMAC_Get_Dst_Addr(UCHAR ch);
...
@retval D_DD_HDMAC_INPUT_PARAM_ERR	Input Parameter Error
*/
extern	INT32	Dd_HDMAC_Set_Source_Protect(UCHAR ch, UCHAR protect_code);
...
@retval D_DD_HDMAC_INPUT_PARAM_ERR	Input Parameter Error
*/
extern	INT32	Dd_HDMAC_Set_Destination_Protect(UCHAR ch, UCHAR protect_code);
...
*/
extern	INT32	Dd_HDMAC_Set_Arbitration(UCHAR arbitration);
...
@retval D_DD_HDMAC_INPUT_PARAM_ERR	Input Parameter Error
*/
extern	INT32	Dd_HDMAC_Get_Arbitration(UCHAR *const arbitration);
...
@remarks There is an influence in all channels when setting it because it is a common register to all channels.
*/
extern	VOID	Dd_HDMAC_Clear_Arbitration(VOID);

/**
The operation of All HDMAC channel is stopped.
*/
extern	VOID	Dd_HDMAC_Stop_All_Ch(VOID);

/**
The operation of All HDMAC channel is resumed.
*/
extern	VOID	Dd_HDMAC_Resume_All_Ch(VOID);
...
@remarks Total MAX size of this API as following.<br>
         	...
         	BYTE transfer (source address and destination address are 1byte alignment) : MAX size is 1MByte.<br>
*/
extern	UCHAR	Dd_HDMAC_Get_Trns_Width(ULONG src_addr, ULONG dst_addr, ULONG total_size);
...
*/
extern	VOID	Dd_HDMAC_Set_Int_Handler(UCHAR ch, VOID (*int_handler)(VOID));
...
@remarks	This API uses DDIM_User_Twai_Flg().
*/
extern	VOID	Dd_HDMAC_Int_Handler(UCHAR ch);
...
@remarks The unit of forwarding makes a large size give priority.<br>
         ...
         Transfer MAX size of this API as following.<br>
         	...
         	BYTE transfer (source address and destination address are 1byte alignment) : MAX size is 1MByte.<br>
*/
extern	INT32	Dd_HDMAC_Copy_SDRAM_Sync(UCHAR ch, ULONG src_addr, ULONG dst_addr, ULONG size, UINT32 wait_mode);
...
@remarks The unit of forwarding makes a large size give priority.<br>
         ...
         Transfer MAX size of this API as following.<br>
         	...
         	BYTE transfer (source address and destination address are 1byte alignment) : MAX size is 1MByte.<br>
*/
extern	INT32	Dd_HDMAC_Copy_SDRAM_Async(UCHAR ch, ULONG src_addr, ULONG dst_addr, ULONG size, VP_CALLBACK intHandler);
...
@{
	...
	hdmac_ctrl_trns.int_handler      = sample_hdmac_callback;
