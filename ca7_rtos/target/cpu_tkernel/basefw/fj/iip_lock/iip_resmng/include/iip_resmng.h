...
#ifndef _IIP_RESOURCE_H_
#define _IIP_RESOURCE_H_
...
#define D_IIP_ERR_NG			(-1)
#define D_IIP_ERR_OK			(0)
#define D_IIP_ERR_TMOUT			(1)

/** Other resource bitmask */
#define D_IIP_RES_OTHER_NONE			(0)						/**< Nothing */
#define D_IIP_RES_OTHER_LUT_A			(1 << 0)				/**< LUT A */
#define D_IIP_RES_OTHER_LUT_B			(1 << 1)				/**< LUT B */
#define D_IIP_RES_OTHER_LUT_C			(1 << 2)				/**< LUT C */
#define D_IIP_RES_OTHER_LUT_D			(1 << 3)				/**< LUT D */
#define D_IIP_RES_OTHER_LUT_E			(1 << 4)				/**< LUT E */
#define D_IIP_RES_OTHER_LUT_F			(1 << 5)				/**< LUT F */
#define D_IIP_RES_OTHER_HIST_0			(1 << 6)				/**< Histogram 0 */
#define D_IIP_RES_OTHER_HIST_1			(1 << 7)				/**< Histogram 1 */
#define D_IIP_RES_OTHER_HIST_2			(1 << 8)				/**< Histogram 2 */
#define D_IIP_RES_OTHER_HIST_3			(1 << 9)				/**< Histogram 3 */
#define D_IIP_RES_OTHER_BICUBIC_0		(1 << 13)				/**< Bi-Cubic calculator 0 */
#define D_IIP_RES_OTHER_BICUBIC_1		(1 << 14)				/**< Bi-Cubic calculator 1 */
#define D_IIP_RES_OTHER_BICUBIC_0_OR_1	(1 << 15)				/**< Bi-Cubic calculator 0 or 1 */
...
typedef struct {
	...
	UCHAR		sl_master_if_2;						/**< SL 8, 5, 2 (8:Master I/F 2 only  2:Master I/F0 or 2  5:Master I/F0 or 2) */
	UCHAR		sl0;								/**< SL0 only */
	UCHAR		sl1;								/**< SL1 only */
	UCHAR		sl2;								/**< SL2 only */
	UCHAR		sl3;								/**< SL3 only */
...
} T_IIP_RES_UNIT_CONFIG_ARG;

/** Lock requested number */
typedef struct {
	T_IIP_RES_UNIT_CONFIG_ARG		unit;			/** Lock requested number by unit */
	UCHAR							pixid;			/** Lock requested number by PIXFMTTBL(PIXID) */
	UINT32							other;			/** Lock requested resource bitmask (D_IIP_RES_OTHER_XXXX) */
} T_IIP_RES_CONFIG_ARG;

/** IIP resource bitmask */
typedef struct {
	ULLONG						unitid_bitmask64;	/** Locked unit bitmask */
	UINT32						pixid_bitmask;		/** Locked PIXFMTTBL(PIXID) bitmask */
	UINT32						other_bitmask;		/** Locked resource bitmask (bitmask of D_IIP_RES_OTHER_xxx) */
} T_IIP_RES_CONFIG_OUT;
...
@remarks	
*/
extern INT32 IIP_Res_Config_Lock( T_IIP_RES_CONFIG_OUT config_out[], const T_IIP_RES_CONFIG_ARG config_arg[], const UCHAR config_num, const INT32 wait_time, const T_IIP_RES_USER* user_info  );

/**
 Release the IIP resource.
...
@remarks	
*/
extern INT32 IIP_Res_Config_Free( const T_IIP_RES_CONFIG_OUT config_out[], const UCHAR config_num, const INT32 wait_time );

#ifdef __cplusplus
}
#endif	// __cplusplus

#endif	// _IIP_RESOURCE_H_
