 ...
 */
#ifndef	_SDIO0_REG_DEF_H_
#define	_SDIO0_REG_DEF_H_
...
------------------------------------------------------------
*/
#define D_SD_REG_SYS_ADDR			IO_SDXC4.SYSADDR							// System Address Register
#define D_SD_REG_BLK_SIZE			IO_SDXC4.BLKINFO.hword.BlockSize			// Block Size Register
#define D_SD_REG_BLK_CNT			IO_SDXC4.BLKINFO.hword.BlockCount			// Block Count Register
#define D_SD_REG_ARG1_0				IO_SDXC4.ARG1_0								// Argument1_0 Register
#define D_SD_REG_CMD_TRNS			IO_SDXC4.TRNSINFO.word						// Command Register & Transfer Mode Register
#define D_SD_REG_TRNS_MODE			IO_SDXC4.TRNSINFO.hword.TransferMode		// Transfer Mode Register
#define D_SD_REG_CMD				IO_SDXC4.TRNSINFO.hword.Command				// Command Register
#define D_SD_REG_RESP1_0			IO_SDXC4.RESP1_0							// Response1_0 Register
#define D_SD_REG_RESP3_2			IO_SDXC4.RESP3_2							// Response3_2 Register
#define D_SD_REG_RESP5_4			IO_SDXC4.RESP5_4							// Response5_4 Register
#define D_SD_REG_RESP7_6			IO_SDXC4.RESP7_6							// Response7_6 Register
#define D_SD_REG_BUF_DAT			IO_SDXC4.BUFDAT								// Buffer Data Port Register
#define D_SD_REG_PRE_STAT			IO_SDXC4.PREST.word							// Present State Register
#define D_SD_REG_HOST_CTRL			IO_SDXC4.CTRL1.byte.HostControl1			// Host Control1 Register
#define D_SD_REG_PWR_CTRL			IO_SDXC4.CTRL1.byte.PowerControl			// Power Control Register
#define D_SD_REG_BLK_GAP_CTRL		IO_SDXC4.CTRL1.byte.BlockGapControl			// Block Gap Control Register
#define D_SD_REG_WAKEUP_CTRL		IO_SDXC4.CTRL1.byte.WakeupControl			// Wakeup Control Register
#define D_SD_REG_CLK_CTRL			IO_SDXC4.CTRL3.byte.ClockControl			// Clock Control Register
#define D_SD_REG_TOUT_CTRL			IO_SDXC4.CTRL3.byte.TimeoutControl			// Timeout Control Register
#define D_SD_REG_SOFT_RST			IO_SDXC4.CTRL3.byte.SoftReset				// Software Reset Register
#define D_SD_REG_EINT_ST_NINT_ST	IO_SDXC4.INTST.word							// Error Interrupt Status Register & Normal Interrupt Status Register
#define D_SD_REG_NINT_ST			IO_SDXC4.INTST.hword.NIntStatus				// Normal Interrupt Status Register
#define D_SD_REG_EINT_ST			IO_SDXC4.INTST.hword.EIntStatus				// Error Interrupt Status Register
#define D_SD_REG_NINT_ST_EN			IO_SDXC4.INTSTENB.hword.NIntStatusEnable	// Normal Interrupt Status Enable Register
#define D_SD_REG_EINT_ST_EN			IO_SDXC4.INTSTENB.hword.EIntStatusEnable	// Error Interrupt Status Enable Register
#define D_SD_REG_NINT_SIG_EN		IO_SDXC4.INTSIGENB.hword.NIntSignalEnable	// Normal Interrupt Signal Enable Register
#define D_SD_REG_EINT_SIG_EN		IO_SDXC4.INTSIGENB.hword.EIntSignalEnable	// Error Interrupt Signal Enable Register
#define D_SD_REG_ACMD12E_ST			IO_SDXC4.CTRL2.hword.ACMDEStatus			// Auto CMD Error Status Register
#define D_SD_REG_HOST_CTRL2			IO_SDXC4.CTRL2.hword.HostControl2			// Host Control2 Register
#define D_SD_REG_CAPA0				IO_SDXC4.CAP1_0.hword.Capa0					// Capabilities0 Register
#define D_SD_REG_CAPA1				IO_SDXC4.CAP1_0.hword.Capa1					// Capabilities1 Register
#define D_SD_REG_MAX_CUR_CAPA0		IO_SDXC4.MCURCAP1_0.hword.MaxCurrentCapa0	// Maximum Current Capabilities0 Register
#define D_SD_REG_MAX_CUR_CAPA1		IO_SDXC4.MCURCAP1_0.hword.MaxCurrentCapa1	// Maximum Current Capabilities1 Register
#define D_SD_REG_FRC_EVT_ACMD		IO_SDXC4.hword.ForceEventForACMD			// Force Eveent for Auto CMD Register
#define D_SD_REG_FRC_EVT_ERR_INT	IO_SDXC4.FOREVT.hword.ForceEventForErrInt	// Force Event for Error Interrupt Register
#define D_SD_REG_ADMA_ERR_ST		IO_SDXC4.ADMAEST.word						// ADMA Error Status Register
#define D_SD_REG_ADMA_SYS_ADDR		IO_SDXC4.ADMASYSADDR_L						// ADMA System Address Register (Low)
#define D_SD_REG_PRE_VAL_INIT		IO_SDXC4.PREVAL1.hword.PresetValueForInit	// Preset Value for Initialize
#define D_SD_REG_PRE_VAL_DS			IO_SDXC4.PREVAL1.hword.PresetValueForDS		// Preset Value for Default Speed
#define D_SD_REG_PRE_VAL_HS			IO_SDXC4.PREVAL2.hword.PresetValueForHS		// Preset Value for High Speed
#define D_SD_REG_PRE_VAL_SDR12		IO_SDXC4.PREVAL2.hword.PresetValueForSDR12	// Preset Value for SDR12
#define D_SD_REG_PRE_VAL_SDR25		IO_SDXC4.PREVAL3.hword.PresetValueForSDR25	// Preset Value for SDR25
#define D_SD_REG_PRE_VAL_SDR50		IO_SDXC4.PREVAL3.hword.PresetValueForSDR50	// Preset Value for SDR50
#define D_SD_REG_PRE_VAL_SDR104		IO_SDXC4.PREVAL4.hword.PresetValueForSDR104	// Preset Value for SDR104
#define D_SD_REG_PRE_VAL_DDR50		IO_SDXC4.PREVAL4.hword.PresetValueForDDR50	// Preset Value for DDR50
#define D_SD_REG_SHR_BUS_CTRL		IO_SDXC4.SharedBusControl.word				// Shared Bus Control Register
#define D_SD_REG_SLOT_INT_ST		IO_SDXC4.HCTRLVER.hword.SIntStatus			// Slot Interrupt Status Register
#define D_SD_REG_HOST_CTRL_SPEC		IO_SDXC4.HCTRLVER.hword.HostContSPEC		// Host Controller Spec Register
#define D_SD_REG_HOST_CTRL_VENDER	IO_SDXC4.HCTRLVER.hword.HostContVENDER		// Host Controller Vender Register

#define D_SD_REG_AHB_CONFIG			IO_SDXC4.AHBCNF.word						// AHB Config Register
#define D_SD_REG_POWER_SWITCH		IO_SDXC4.POWSW.word							// Power Switching Register
#define D_SD_REG_TUNING_SET			IO_SDXC4.TUNSET.word						// Tuning Setting Register
#define D_SD_REG_TUNING_ST			IO_SDXC4.TUNST.word							// Tuning Status Register
#define D_SD_REG_IO_CTRL1			IO_SDXC4.IOCTRL1.word						// I/O Control1 Register
#define D_SD_REG_IO_CTRL2			IO_SDXC4.IOCTRL2.word						// I/O Control2 Register
#define D_SD_REG_POW_SW_INT_ST		IO_SDXC4.POWSWST.word						// Power switching Interrupt Status Register
#define D_SD_REG_POW_SW_INT_ST_EN	IO_SDXC4.POWSWSTENB.word					// Power switching Interrupt Status Enable Register
#define D_SD_REG_POW_SW_INT_SIG_EN	IO_SDXC4.POWSWSIGENB.word					// Power switching Interrupt Status Signal Enable Register
#define D_SD_REG_MMC_ESD_CTRL		IO_SDXC4.MMC_ESDCTRL.word					// MMC/eSD Control Register
#define D_SD_REG_MMC_WAITIRQ_CTRL1	IO_SDXC4.MMC_WAIT_IRQ_CTRL1.word			// MMC Wait IRQ Control1 Register
#define D_SD_REG_MMC_WAITIRQ_CTRL2	IO_SDXC4.MMC_WAIT_IRQ_CTRL2.word			// MMC Wait IRQ Control2 Register
#define D_SD_REG_MMC_RES_CHK		IO_SDXC4.MMC_RES_CHK.word					// MMC Response Check Bit Register
#define D_SD_REG_CARD_DETECT_SET	IO_SDXC4.CDSET.word							// Card Detect Setting Register (* ReadOnly)
#define D_SD_REG_SOFT_RESET			IO_SDXC4.SOFT_RESET.word					// SOFT_RESET Register
#define D_SD_REG_HDCLK_SEL			IO_SDXC4.HDCLK_SEL.word						// HDCLK_SEL Register
#define D_SD_REG_HPROT_SET			IO_SDXC4.HPORT_SET.word						// HPROT_SET Register
#define D_SD_REG_CLK_STOP			IO_SDXC4.CLK_STOP							// Clock Stop Register
#define D_SD_REG_WP_CD_LED_SET		IO_SDXC4.WP_CD_LED_SET.word					// WP_CD_LED_SET Register
#define D_SD_REG_RETUN_REQ			IO_SDXC4.RETUNING_REQ.word					// RE-TUNING_REQ Register
#define D_SD_REG_RETUN_REQ_CLR		IO_SDXC4.RETUNING_REQ_CLR.word				// RE-TUNING_REQ_CLR Register
#define D_SD_REG_CR_SET				IO_SDXC4.CR_SET.word						// CR_SET Register
#define D_SD_REG_CDR_SET			IO_SDXC4.CDR_SET.word						// CDR_SET Register
#define D_SD_REG_PV_SET1			IO_SDXC4.PV_SET1.word						// PV_SET1 Register
#define D_SD_REG_PV_SET2			IO_SDXC4.PV_SET2.word						// PV_SET2 Register
#define D_SD_REG_PV_SET3			IO_SDXC4.PV_SET3.word						// PV_SET3 Register
#define D_SD_REG_PV_SET4			IO_SDXC4.PV_SET4.word						// PV_SET4 Register
...
----------------------------------*/
//---- bit Check -----
#define D_SD_SR_RSTX						0x00000001		// Soft Reset bit

//---- Status -----
#define D_SD_SOFT_RESET_DIS					0x00000001		// SOFT_RESET Not Reset
