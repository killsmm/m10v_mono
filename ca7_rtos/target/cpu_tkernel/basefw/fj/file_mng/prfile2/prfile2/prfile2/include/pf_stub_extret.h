 ...
 */
 /****************************************************************************
 [pf_stub_extret.h] - PrFILE2 EXTRET API Stub functions declarations
 ...
 ****************************************************************************/
#ifndef __PF_STUB_EXTRET_H__
#define __PF_STUB_EXTRET_H__
...
/*---------------------------------------------------------------------------
 pfstub_call_function_extret - EXTRET API stub function call.

 [Synopsis]
    void  pfstub_call_function_extret(FCPFNC *fnctab);
        fnctab       PrFILE2 function parameter table structure.

 [Description]
    Call each PrFILE2 EXTRET API routine.
