...
/*---------------------------------------------------------------------------
 pfstub_call_function_module

 [Synopsis]
    void  pfstub_call_function_module(FCPFNC *fnctab);
        fnctab       PrFILE2 function parameter table structure.

 [Description]
    Call each PrFILE2 Extension-API routine.
