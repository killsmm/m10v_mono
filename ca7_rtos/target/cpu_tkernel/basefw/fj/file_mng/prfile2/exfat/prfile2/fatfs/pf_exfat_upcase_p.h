 ...
 ****************************************************************************/
#ifndef __PF_EXFAT_UPCASE_P_H__
#define __PF_EXFAT_UPCASE_P_H__
...
#define PF_UPCASE_COMPRESS_CODE     (0xFFFF)    /* Compression code in Up-case Table */

#endif  /* PF_EXFAT_SUPPORT */

#endif  /* __PF_EXFAT_UPCASE_P_H__ */
