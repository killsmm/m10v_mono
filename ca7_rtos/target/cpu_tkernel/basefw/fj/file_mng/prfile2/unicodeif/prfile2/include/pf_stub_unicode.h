 ...
 ****************************************************************************/
#ifndef __PF_STUB_UNICODE_H__
#define __PF_STUB_UNICODE_H__
...
/*---------------------------------------------------------------------------
 pfstub_call_function_unicode - Unicode API stub function call.

 [Synopsis]
    void  pfstub_call_function_unicode(FCPFNC *fnctab);
