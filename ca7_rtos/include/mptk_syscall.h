...
#ifndef __MPTK_SYSCALL_H__
#define __MPTK_SYSCALL_H__
...
#define TA_USERBUF	0x00000020U	/* User specified buffer address */
#define TA_DSNAME	0x00000040U	/* Use object name */
#define TA_NODISWAI	0x00000080U	/* Wait disable rejection */
...
typedef	struct t_cmpl {
	...
	VP	bufptr;		/* User specified buffer address */
	ID	domid;		/* Domain ID */
	UB	oname[8];	/* Object name */
} T_CMPL;
...
typedef struct t_cop0regs {
	...
	UW	fpexc; /* Floating-Point Exception Register */
} T_COP0REGS;
...
IMPORT void GetReleaseVersion( UINT* relver );
/* [END SYSCALLS] */
